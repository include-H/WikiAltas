...
## This task
A question, not a writing job: read what you need, then answer with the answer tool. Do not modify content.
...
No write tool is present in this run: content is read-only. Answer, analyse and suggest — never claim you changed something.
